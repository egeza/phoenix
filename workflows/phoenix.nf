...
workflow PHOENIX_EXTERNAL {
    ...
    main:
        ...
        // --- Abricate: virulence genes for Escherichia (VFDB) ---
        ecoli_scaffolds_ch = BBMAP_REFORMAT.out.filtered_scaffolds
        ...
        ABRICATE_VFDB(ecoli_scaffolds_ch.map{ meta, scaffolds -> [meta, scaffolds, "vfdb"] })
        ch_versions = ch_versions.mix(ABRICATE_VFDB.out.versions)
        abricate_vfdb_ch = ABRICATE_VFDB.out.report
